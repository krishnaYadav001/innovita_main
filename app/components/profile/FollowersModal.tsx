...
export default function FollowersModal({ isOpen, onClose, followers, title = "Followers" }: FollowersModalProps) {
        ...
        <div className="overflow-y-auto max-h-[60vh] p-2">
          {followers.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-10">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-center">No {title.toLowerCase()} yet</p>
            </div>
          )}
        </div>
      </div>
